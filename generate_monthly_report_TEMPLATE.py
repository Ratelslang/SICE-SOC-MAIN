#!/usr/bin/env python3
"""
SICE Monthly Security Report Generator — TEMPLATE VERSION
Fill in your actual data below, then run: python3 generate_monthly_report_TEMPLATE.py 7 2026
"""
...
def create_monthly_report(filename, month, year, data=None):
    ...
    # ============================================================
    # ============ EDIT YOUR DATA HERE EACH MONTH ===============
    # ============================================================
    
    if data is None:
        data = {
            # CHANGE THESE NUMBERS EACH MONTH:
            'total_incidents': 2,              # How many incidents this month?
            'security_alerts': 6,              # How many security alerts?
            'gate_checks': 200,                # How many gate access checks?
            'cctv_issues': 0,                 # How many CCTV problems?
            'alarm_tests': 4,                 # How many times tested alarm?          
            
            # Areas covered (change if needed):
            'areas_covered': ['Sinoville', 'Montana', 'Pretoria North'],
            
            # Main summary (edit this for your month):
            'summary': '''Soft-Ice Catering Equipment premises maintained optimal security posture throughout July 2026. 
All perimeter controls activated, CCTV systems operational, and alarm systems tested and verified. 
Zero critical security incidents reported. Personnel rotation maintained across three operational zones 
with 480 combined patrol hours. All staff completed mandatory security briefings. 
Recommend continued adherence to current security protocols.'''
        }
    
    # ============================================================
    # ============ REST IS AUTOMATIC — DON'T CHANGE ==============
    # ============================================================
...
if __name__ == '__main__':
    ...
    # Create report with template data
    create_monthly_report(filename, month, year)
    print(f"\n📋 Report created: {filename}")
    print(f"\n💡 To customize for next month:")
    print(f"   1. Open this file in text editor")
    print(f"   2. Edit the 'data' dictionary (lines ~24-37)")
    print(f"   3. Change the numbers for your month")
    print(f"   4. Save and run: python3 generate_monthly_report_TEMPLATE.py 8 2026")
